...
], function(dojo_declare, ecm_widget_listView_Bar, ier_constants, ier_messages, 
		ier_widget_listView_TaskFilter, ier_widget_listView_Toolbar, ier_widget_TasksListingPane){
 ...
 */
return dojo_declare("ier.widget.tasks.ReportTasksListingPane", [ier_widget_TasksListingPane], {

	toolbarDef: "IERReportTaskToolbarMenuType",
