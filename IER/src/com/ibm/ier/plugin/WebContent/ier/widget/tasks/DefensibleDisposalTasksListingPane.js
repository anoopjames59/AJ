 ...
 */
return dojo_declare("ier.widget.tasks.DefensibleDisposalTasksListingPane", [ier_widget_TasksListingPane], {
	
	toolbarDef: "IERDefensibleDispositionTaskToolbarMenuType",
